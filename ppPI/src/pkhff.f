...
*                                                                     *
*  as in S. Kretzer (kretzer@hal1.physik.uni-dortmund.de):            *
*                                                                     * 
*  `Fragmentaion Functions from Flavour-inclusive and Flavour-tagged  *
*  e^+ e^- Annihilations';                                            *
*  DO-TH 00/04; hep-ph/0003177; (submitted to Phys. Rev. D)           *
*  ( this code from 03/25/00 )                                        *
*                                                                     *
...
c           WRITE(6,91) 
c  91       FORMAT (2X,'PARTON INTERPOLATION: Z OUT OF RANGE')
c           write(6,*) z
c       stop
       ENDIF
